...
// You chose the North path! The nor
h path leads you to your hometown with few inhabitants, yet there is a town in between that may be hostile. 
...
public class Adventure {
    ...
    public static void main(String[] args) {
        ...
        String direction = "";
HP        while (direction != "left" || direction != "right") {
            System.out.println("CROSSROADS 1: You come accross 2 paths with signs that describe the paths, they are called the North and South paths. type your desired path");
